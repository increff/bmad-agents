...
=======
=======
<<<<<<< HEAD:expansion-packs/bmad-regression-testing/templates/test-generation-templates.md
  ...
  regression_detection:
    ...
    code: |
      ...
      def detect_regression(current_file, baseline_file, tolerance=0.01):
          ...
          diff_pct = abs(current_sum - baseline_sum) / baseline_sum
          assert diff_pct <= tolerance, f"Regression detected: {diff_pct:.2%} change"
>>>>>>> 0a109ec (Enhance BMAD Regression Testing Configuration and Documentation):expansion-packs/bmad-regression-testing/templates/test-generation-templates.yaml
>>>>>>> 6686707 (Enhance BMAD Regression Testing Configuration and Documentation)
